...
namespace Ilyes_Andrea_Lab2.Controllers
{
    ...
    {
        private readonly Ilyes_Andrea_Lab2Context _context;

        public OrdersController(Ilyes_Andrea_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var ilyes_Andrea_Lab2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
